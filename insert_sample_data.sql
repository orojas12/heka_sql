...
INSERT INTO orders (customer_id, ship_address_same_as_customer, date_placed, date_shipped,
  date_delivered)
  VALUES
    (1, 1, CURDATE(), NULL, NULL),
    (2, 1, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 1 DAY), NULL),
    (1, 1, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 1 DAY), DATE_ADD(CURDATE(), INTERVAL 2 DAY)),
    (3, 1, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 1 DAY), DATE_ADD(CURDATE(), INTERVAL 2 DAY))
;

INSERT INTO orders (customer_id, ship_address_same_as_customer, ship_street, ship_city, ship_state,
  ship_zip, date_placed, date_shipped, date_delivered)
  VALUES
    (2, 0, '100 Fake St', 'Dallas', 'TX', '79936', CURDATE(), DATE_ADD(CURDATE(), INTERVAL 1 DAY), NULL),
    (3, 0, '200 Fake St', 'Houston', 'TX', '79928', CURDATE(), DATE_ADD(CURDATE(), INTERVAL 1 DAY), 
      DATE_ADD(CURDATE(), INTERVAL 2 DAY))
;

INSERT INTO vaccine_containers VALUES
  ('5662ed77-8f0e-4f42-89cb-9ad9a904040a', 1, 1, 1),
  ('1bf32878-8ea5-4826-9714-60b52e2bde53', 1, 1, 1),
  ('6eae56a9-6be1-47ae-a5ca-1c333957fc5b', 2, 2, 1),
  ('2d609ea3-2219-434c-a113-b90548b31620', 2, 2, 1),
  ('49fdf4b5-6c10-4dc7-aa06-dcfe16c35464', 3, 1, 1),
  ('f9fd59f7-4b51-4765-9761-21101a5b0938', 3, 2, 2),
  ('98b50347-5ac4-4fcc-9600-7412a884b682', 3, 1, 2),
  ('8e37e731-da5d-4995-82fb-5ba36c0540e7', 4, 3, 2),
  ('b50a4863-7b67-4a6d-beb6-7e1227cb39e7', 5, 1, 2),
  ('fa11c09d-928b-43dc-8475-9cc7e8236caa', 5, 1, 3),
  ('40c25ff1-7ebb-4a46-9f97-87cf03afdcfa', 6, 2, 3),
  ('b5a2caa1-21af-4a9d-8be0-e650fcb22665', 6, 2, 3),
  ('427bec84-34c3-4796-ab7e-383bfc929a73', 6, 2, 3)
;

INSERT INTO ancillary_kits VALUES
  ('2618e978-1bc5-4b11-939b-977abed7655e', 1, 1, 1),
  ('b9fd51d0-047d-4681-86a5-4c7312ba6c7a', 1, 1, 1),
  ('3acf14cb-1f85-405b-8d91-61becd05b23f', 2, 2, 1),
  ('564d3680-2f3d-4ffc-83e2-457f8205e119', 2, 2, 1),
  ('28c101fa-13a6-4865-87e6-8ffc3c380ca9', 3, 1, 2),
  ('8ac77e6e-e6cb-4f38-b805-909c9a8b9ec7', 3, 2, 2),
  ('2391e123-c987-4749-878c-d08fda5a6a9a', 3, 1, 2),
  ('b119b5c0-bdd2-4640-b028-b25dfe8dcf03', 4, 3, 2),
  ('723692aa-8ac2-44d4-abba-c771fdf1129e', 5, 1, 3),
  ('ccd902f7-687f-44d1-9557-60d77e7604b8', 5, 1, 3),
  ('5bf4bab7-85df-43e7-ad71-27655098e77a', 6, 2, 3),
  ('24383617-22c7-465d-8a9f-538819e568de', 6, 2, 3),
  ('e5388635-7156-47e4-a4f3-d3fadb1abea7', 6, 2, 3)
;
